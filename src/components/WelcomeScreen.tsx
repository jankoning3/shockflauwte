...
#009fe3]" />
        ...
        <div className="bg-[
#52bbb5]/10 rounded-lg p-4 mb-6 text-sm text-gray-700 border border-[
#52bbb5]/20">
...
#006072]">Spelregels:</p>
        ...
        <button
          ...
          className="w-full bg-[
#009fe3] hover:bg-[
#006072] text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-2 text-lg shadow-lg hover:shadow-xl transform hover:scale-105 border-2 border-[
#009fe3] hover:border-[
#006072]"
        >
        ...
        <div className="mt-6 pt-4 border-t border-gray-200">
          <p className="text-sm text-gray-500">
            Powered by <span className="text-[
#009fe3] font-semibold">Soliede</span>
          </p>
        </div>
      </div>
    </div>
